                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 text-left mt-3 mb-0">
                            <address class="ib mr-2">
                                ...
                                <br>
                                {{ config.establishment.email }} - <span
                                v-if="config.establishment.telephone != '-'">{{ config.establishment.telephone }}</span>
                            </address>
                        </div>
                    </div>
                </header>
            ...
            .then(() => {
                ...
                if (fromCotizacion !== undefined && fromCotizacion && q !== undefined) {
                    this.$http.post(`/${this.resource}/Quotation/get/${q}`)
                        ...
                        .catch(error => {
                            console.log('Error intentando crear un pedido desde cotizacion.')
                            console.error(error)
                        })
                        .finally(() => {
