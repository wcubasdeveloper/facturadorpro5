...
<table class="full-width">
    <tr>
        ...
        <td width="40%" class="border-box p-box-info text-center">
            <h3><strong>{{ 'RUC '.$company->number }}</h3></strong>
    ...
    <tr>
        <td class="pl-3">
            <div class="text-left">
                ...
                <p>{{ ($establishment->telephone !== '-')? 'Central telefónica: '.$establishment->telephone : '' }}</h6>
                <p>{{ ($establishment->email !== '-')? 'Email: '.$establishment->email : '' }}</h6>
