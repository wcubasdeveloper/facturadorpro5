...
<table class="full-width mt-10 mb-10">
    <thead class="">
    <tr class="bg-grey">
        <th class="border-top-bottom text-left py-2"
            width="">COD.
        </th>
        ...
        <th class="border-top-bottom text-left py-2">LABORATORIO</th>
    ...
    <tr>
        <td colspan="5"
            class="font-lg"
            style="padding-top: 2rem;text-transform: uppercase;">Son:
            <span class="font-bold">{{ $document->number_to_letter }} {{ $document->currency_type->description }}</span>
        </td>
    </tr>
...
<table class="full-width">
    <tr>
        <td width="65%">
            <div class="text-left"><img class="qr_code"
                                        src="data:image/png;base64, {{ $document->qr }}"/></div>
