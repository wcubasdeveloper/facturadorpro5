...
<div class="item_watermark" style="position: absolute; text-align: center; top:35%;">
    <img style="width: 100%" height="180px" src="data:{{mime_content_type($marca_agua)}};base64, {{base64_encode(file_get_contents($marca_agua))}}" alt="marca_agua" class="" style="opacity: 0.2;width: 95%">
</div>
