...
<table class="full-width">
    <tr>
        ...
        <td width="30%" class="border-box py-4 px-2 text-center" style="line-height:1.5;">
            <h5>{{ 'RUC '.$company->number }}</h5> 
            <h5 class="text-center">{{ $document->document_type->description }}</h5> 
            <h3 class="text-center" style="font-weight: bold;">{{ $document_number }}</h3>
        </td>
    </tr>
</table>
...
<table class="full-width mt-10 mb-10">
    ...
    @foreach($document->items as $row)
        <tr>
            <td class="text-left align-top" style="font-size: 9px;">
